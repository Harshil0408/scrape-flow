...
const ExecutionTable = ({ workflowId, initialData }: { workflowId: string, initialData: InitialDataType }) => {
            ...
            <Table className="h-full">
                ...
                <TableBody className="gap-2 h-full overflow-auto">
                    {query.data.map((execution) => {
                        ...
                        return (
                            <TableRow key={execution.id} className="cursor-pointer" onClick={() => { router.push(`/workflow/runs/${execution.workflowId}/${execution.id}`) }}>
                                <TableCell>
                                    <div className="flex flex-col">
                                        <span className="font-semibold">{execution.id}</span>
                                        <div className="text-muted-foreground text-xs">
                                            <span className="mr-2">Triggered via</span>
