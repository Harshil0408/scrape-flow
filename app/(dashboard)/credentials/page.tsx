...
import CreateCredentialsDialog from "./_components/create-credentials"
import { formatDistanceToNow } from "date-fns"
import DeleteCredentialDialog from "./_components/delete-credentials-dialog"
        ...
        <div className="flex flex-1 flex-col h-full">
            ...
            <div className="h-full py-6 space-y-8">
                <Alert>
                    ...
                    <AlertDescription>
                        All information is securely encrypted, your data remains safe
                    </AlertDescription>
                </Alert>
...
async function UserCredentials() {
    ...
    if (credentials.length === 0) {
        return (
            <Card className="w-ful px-4 py-8">
                <div className="flex flex-col gap-4 items-center justify-center">
                    <div className="rounded-full bg-accent h-20 w-20 flex items-center justify-center">
                        <ShieldOffIcon className="stroke-primary" />
                    </div>
                    <div className="flex flex-col gap-1 text-center">
                        <p className="font-bold">No credentials yet</p>
                        <p className="text-sm text-muted-foreground">Click the button to create your first credentials</p>
                    </div>
